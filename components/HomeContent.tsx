  ...
  return (
    <div className="h-screen flex flex-col pt-16 pb-4 md:pt-32 md:pb-8 pl-2 pr-3 md:px-6">
      ...
      <div className="flex-1 flex md:grid md:grid-cols-12 gap-4 md:gap-6 min-h-0 overflow-visible">
        ...
        <div className="hidden md:block md:col-span-8 relative pl-[50px] border-l border-gray-200">
          {/* Top fade overlay */}
          ...
          <div className="absolute inset-0 left-[50px] overflow-y-auto custom-scrollbar">
          {selectedProject ? (
