        ...
        <div className="h-screen pt-48 pb-16">
          <div className="h-full grid grid-cols-12 gap-6">
            ...
            <div className="col-span-1 flex justify-end items-start">
              <Link href="/">
                <motion.div
                  className="w-10 h-10 rounded-full bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center flex-shrink-0 mt-1 cursor-pointer hover:scale-105 transition-transform"
                  layoutId="avatar"
                >
